...
```
- Number of training samples: 2560 (320 samples per label)
- Number of validation samples: 320 (40 samples per label)
- Number of test samples: 320 (40 samples per label)
- Image size: 224x224
```
